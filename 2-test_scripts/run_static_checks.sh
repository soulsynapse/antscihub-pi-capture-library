...
grep -qi 'CAMERA_PROFILE_MODE' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
grep -qi 'imx708' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
grep -qi 'set_desired_owlcam_profile' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
grep -qi 'set_desired_auto_profile' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
...
grep -q 'detect_owlcam_via_i2c' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
grep -q 'i2ctransfer' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
grep -q 'dynamic-no-camera-probe-state' "${REPO_ROOT}/1-capture_config/apply_camera_config.sh"
...
grep -q 'ensure_i2c_tools' "${REPO_ROOT}/install.sh"
grep -q 'ensure_capture_env_file' "${REPO_ROOT}/install.sh"
grep -q 'EnvironmentFile=-${CAPTURE_ENV_FILE}' "${REPO_ROOT}/install.sh"
grep -q 'dynamic|auto|owlcam|imx708' "${REPO_ROOT}/1-capture_config/README.md"
