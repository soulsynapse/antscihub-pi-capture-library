...
grep -q 'write_default_focus_script' "${REPO_ROOT}/1-capture_config/antcam"
grep -q 'start_focus_check' "${REPO_ROOT}/1-capture_config/antcam"
grep -q 'autofocus-mode auto' "${REPO_ROOT}/1-capture_config/antcam"
...
grep -q 'focus.sh' "${REPO_ROOT}/3-recording_scripts/README.md"
