...
main() {
    ...
    log_info "  sudo antcam report cam"
    log_info "  sudo antcam apply imx708"
    log_info "  antcam set focus 7.5"
    log_info "  antcam set focus auto"
    log_info "  antcam set fps 1"
    log_info "  antcam set length 30h"
    log_info "  antcam set segment 10m"
    log_info "  antcam set loop 1m"
    log_info "  antcam report focus"
    log_info "  antcam report fps"
    log_info "  antcam report length"
    log_info "  antcam report segment"
    log_info "  antcam report loop"
