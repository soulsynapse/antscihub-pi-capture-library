...
main() {
    ...
    log_info "  antcam ev set auto"
    log_info "  antcam saturation set 1"
    log_info "  antcam awbgains set auto"
    log_info "  antcam fps set 1"
    log_info "  antcam length set 30h"
    log_info "  antcam segment set 10m"
    log_info "  antcam intra set 30"
    log_info "  antcam photo-every set 1m"
    log_info "  antcam focus report"
    log_info "  antcam ev report"
    log_info "  antcam saturation report"
    log_info "  antcam awbgains report"
    log_info "  antcam fps report"
    log_info "  antcam length report"
    log_info "  antcam segment report"
    log_info "  antcam intra report"
    ...
    log_info "  antcam transcode set off"
    log_info "  antcam transcode set mux"
    log_info "  antcam transcode set crf:18"
    log_info "  antcam transcode report"
